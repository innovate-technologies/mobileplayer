angular.module("player.services").service("colorsService", colorsService);

colorsService.$inject = [];
...
function colorsService() {
    ...
    function getTheme(backgroundColour) {
    ...
    function getShadedBackgroundColour(color) {
        var shadeMultiplier = 0.15;
        var lightenOrDarken = getTheme(color, 64) === "light" ? -1 : 1;
        return shadeColour(color, shadeMultiplier * lightenOrDarken);
    }

    return {
        getShadedBackgroundColour: getShadedBackgroundColour
    };
}
